...
train_dataset = dataset.create_dataset(np.load(train_images_paths[0]), normalize=True)
...
for resolution, train_dataset_path in enumerate(train_images_paths[1:]):
    train_dataset = dataset.create_dataset(np.load(train_dataset_path), normalize=True)
